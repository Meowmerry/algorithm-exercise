...
const treeIncludesDepthFirst = (root, target) => {
  ...
  return (
    treeIncludesDepthFirst(root.left, target) ||
    treeIncludesDepthFirst(root.right, target)
  );
};
...
console.log(`stack ${treeIncludes(a, "b")}`); // -> true)
console.log(`stack ${treeIncludes(a, "n")}`); // -> false)
